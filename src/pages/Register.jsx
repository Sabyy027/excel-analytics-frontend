...
function Register() {
  ...
  return (
    ...
    <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md mt-10 dark:bg-gray-800 dark:shadow-lg dark:border dark:border-gray-700">
      ...
      <h1 className="text-3xl font-bold text-center text-gray-800 mb-6 dark:text-white">Register</h1>
      <form onSubmit={onSubmit}>
        ...
        <div className="flex items-center justify-between mb-6">
          <button
            type="submit"
            className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-medium py-2 px-6 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            Create Account
          </button>
        </div>
      ...
      <div className="text-center">
        <p className="text-gray-600 mb-4 dark:text-gray-400">Already have an account?</p>
        <Link 
          to="/login" 
          className="inline-block bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-medium py-2 px-6 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
        >
          Sign In
        </Link>
      </div>
